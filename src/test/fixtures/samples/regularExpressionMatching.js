...
regularExpressionMatching("a", "a");
regularExpressionMatching("aa", "aa");
regularExpressionMatching("aab", "aab");
regularExpressionMatching("aab", "aa.");
regularExpressionMatching("aab", ".a.");
regularExpressionMatching("aab", "...");
regularExpressionMatching("a", "a*");
regularExpressionMatching("aaa", "a*");
regularExpressionMatching("aaab", "a*b");
regularExpressionMatching("aaabb", "a*b*");
regularExpressionMatching("aaabb", "a*b*c*");
regularExpressionMatching("", "a*");
regularExpressionMatching("xaabyc", "xa*b.c");
regularExpressionMatching("aab", "c*a*b*");
regularExpressionMatching("mississippi", "mis*is*.p*.");
regularExpressionMatching("ab", ".*");
